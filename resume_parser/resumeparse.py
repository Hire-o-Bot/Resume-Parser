...
class resumeparse(object):
    ...
    def read_file(file,docx_parser = "tika"):
        ...
        file = os.path.join('/home/gg/Documents/FYP/pypi/resume_parser/mt.pdf')
        print(file)
...
obj1=resumeparse();
print(obj1.read_file('/home/gg/Documents/fy/pypi/resume_parser/kr.pdf'))